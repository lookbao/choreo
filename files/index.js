...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.sgtshj.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNzE4MGI4ZDQwYTU0ZTFlMmJhMWY4ODNmZWFlMDViMzAiLCJ0IjoiYzg2OTI4MzgtOTcyOC00ODU5LWJhZGEtMTMxNWMyMDliZjVlIiwicyI6Ik5tWTFZbVpoWTJFdFltTXpaQzAwWVdJMExUazRNVGd0WXpRMVptWTJZelEyWlRFMiJ9';

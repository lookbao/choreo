...
const UUID = process.env.UUID || '26e63757-7b80-4ef1-acd3-b39e5e382234'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo2.adevfgw1.com';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNzE4MGI4ZDQwYTU0ZTFlMmJhMWY4ODNmZWFlMDViMzAiLCJ0IjoiZjJhMmIyMDMtOTYwYS00M2U5LWFhNTAtMTc2NTQ2ZGI2Njc4IiwicyI6Ik1HWmxORFl4TmpZdFkyWXdZUzAwWkRnM0xUbGxPVEV0TmpGbE16VXlPR0ZoWkRZeSJ9';

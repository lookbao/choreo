...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'fsfdvf.kgfkyfd.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"6d324bacb114ecfd5ba33954743869b5","TunnelSecret":"NthuZOymBVxz6Z2uXPokNgFiWw5XHI/0i/3eTXiKAKc=","TunnelID":"62fef244-bfb1-418b-ae65-9018147280e9"}';
